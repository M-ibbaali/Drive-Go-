    ...
    return (
        ...
        <label className="flex items-center mb-3 bg-gray-100 p-3 rounded-lg">
            <input
                ...
                name="payment"
                value="creditCard"
                className="mr-2 border rounded-lg bg-gray-100 text-lg p-3 sm:p-2"
                checked={paymentMethod === 'creditCard'}
                onChange={handlePaymentMethodChange}
            />
            Credit Card
        ...
        {paymentMethod === 'creditCard' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 bg-gray-100 p-3 rounded-lg">
                ...
                <div>
                    <label className="text-gray-700 text-sm">Expiration Date</label>
                    <input
                        type="text"
                        value={paymentData.expirationDate}
                        onChange={handleInputChange}
                ...
                <div>
                    <label className="text-gray-700 text-sm">Card Holder</label>
                    <input
                        type="text"
                        value={paymentData.cardHolder}
                        onChange={handleInputChange}
        ...
        <label className="flex items-center mb-3 bg-gray-100 p-3 rounded-lg">
            ...
            />
            PayPal
            <FaPaypal className="ml-2 text-xl sm:text-lg" />
        </label>
        ...
        {paymentMethod === 'paypal' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 bg-gray-100 p-3 rounded-lg">
                <div>
                    <label className="text-gray-700 text-sm">PayPal Email</label>
                    <input
                        type="email"
                        name="paypalEmail"
                        value={paymentData.paypalEmail}
                ...
                <div>
                    <label className="text-gray-700 text-sm">PayPal Transaction ID (optional)</label>
                    <input
                        type="text"
                        name="transactionId"
                        value={paymentData.transactionId}
                ...
                <div>
                    <label className="text-gray-700 text-sm">Note (optional)</label>
                    <textarea
                        placeholder="Add a note to your payment"
                        className="w-full p-3 sm:p-2 border rounded-lg text-lg sm:text-base focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
