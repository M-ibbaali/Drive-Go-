...
function RentalInfo({ pickupLocation, setPickupLocation, pickupDate, setPickupDate, dropoffLocation, setDropoffLocation, dropoffDate, setDropoffDate, error }) {
    const [pickupLocationValue, setPickupLocationValue] = useState(pickupLocation);
    const [dropoffLocationValue, setDropoffLocationValue] = useState(dropoffLocation);

    useEffect(() => {
        setPickupLocation(pickupLocationValue);
        setDropoffLocation(dropoffLocationValue);
    }, [pickupLocationValue, dropoffLocationValue, setPickupLocation, setDropoffLocation]);
