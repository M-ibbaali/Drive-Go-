...
function Favorite() {
    ...
    {isVisible && (
        <div
            ref={favoriteRef}
            className="bg-white w-[90%] sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] absolute top-14 right-4 sm:right-8 md:right-16 lg:right-32 xl:right-44 p-5 border border-gray-200 rounded-lg shadow-lg z-30"
        >
            {alertMessage && (
                <div
            ...
            {error ? (
                ...
                <div
                    className={`space-y-4 mt-5 ${
                        favorites.length > 5
                            ? 'max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-transparent rounded-lg'
                            : ''
                    }`}
                >
                    {favorites.map((car) => (
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <div>
                                    <h3 className="text-sm sm:text-lg font-medium text-gray-800">{car.name}</h3>
                                    <p className="text-xs sm:text-sm text-gray-500">{car.price}</p>
                                </div>
                            </Link>
                            <button
                                onClick={() => removeFromFavorites(car.vehicle_id)}
