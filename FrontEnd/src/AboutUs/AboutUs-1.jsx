...
const AboutUs = () => {
    const teamMembers = [
        { name: "Karim kribi", role: "Product owner", image: "https://via.placeholder.com/150" },
        { name: "abdlhak bouzougar", role: "Scrum master", image: "https://via.placeholder.com/150" },
        { name: "Abdessamad Ettahiri", role: "devloppeur", image: "https://via.placeholder.com/150" },
        { name: "Mohamed iba ali", role: "devloppeur", image: "https://via.placeholder.com/150" },
    ];
        ...
        <div className="bg-white text-blue-900 font-sans">
            ...
            <section className="flex flex-col md:flex-row items-center py-10 px-5 md:px-20">
                ...
                <div className="md:w-1/2 flex justify-center mt-5 md:mt-0">
                    <img
                        src="/getty_649362670_395940.jpg"
                        alt="About Us"
            ...
            <section className="bg-blue-600 text-white py-10 text-center">
                ...
                <div className="flex justify-center gap-5 flex-wrap">
                    <div className="bg-white text-blue-600 px-4 py-3 rounded shadow-lg w-1/3">
                        <h3 className="font-semibold text-xl mb-2">1. Choose Your Car</h3>
                        <p className="text-sm">Browse our wide selection of cars, from economy to luxury options, and select the one that fits your needs and preferences.</p>
                    </div>
                    <div className="bg-white text-blue-600 px-4 py-3 rounded shadow-lg w-1/3">
                        <h3 className="font-semibold text-xl mb-2">2. Book Online or In-Store</h3>
                        <p className="text-sm">Book your car easily through our website or visit our location to complete the rental process with the help of our friendly staff.</p>
                    </div>
                    <div className="bg-white text-blue-600 px-4 py-3 rounded shadow-lg w-1/3">
                        <h3 className="font-semibold text-xl mb-2">3. Drive Away!</h3>
                        <p className="text-sm">Once your booking is confirmed, pick up your car and drive away. Enjoy a seamless and comfortable rental experience with us.</p>
                    </div>
                </div>
                ...
                <div className="flex justify-center gap-5 mt-4">
                    ...
                    <button className="bg-gray-200 text-blue-600 px-5 py-2 rounded hover:bg-white transition duration-300">
                        Book Now
                    </button>
                </div>
            </section>
            ...
            <section className="bg-white py-16 px-6 text-center">
                ...
                <ul className="text-blue-600">
                    <li><strong>Phone:</strong>  0612345678</li>
                    <li><strong>Location:</strong> Marrakech/sidi youssef ben ali</li>
                    <li><strong>Mail:</strong> emailrentcars@gmail.com</li>
                </ul>
            </section>
