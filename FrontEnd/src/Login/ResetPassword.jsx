...
function ResetPassword() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-100 px-4 sm:px-0">
    <div className="w-full max-w-md sm:max-w-lg p-6 sm:p-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-700 text-center">Reset Password</h1>
