...
function FirstTimeIn({ setIsLoggedIn, setIsGuest }) {
    ...
    {error === 'Invalid email or password.' && (
        <div className="fixed top-1 left-1/2 transform -translate-x-1/2 z-50 bg-red-500 text-white p-3 w-11/12 sm:w-1/3 text-center rounded-lg shadow-lg">
            <p>{error}</p>
        </div>
    )}
    {showAlert && (
        <div className="fixed top-1 left-1/2 transform -translate-x-1/2 z-50 bg-green-500 text-white p-3 w-11/12 sm:w-1/3 text-center rounded-lg shadow-lg">
            <p>{resultat}</p>
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="flex flex-col sm:flex-row w-full max-w-5xl rounded-lg bg-white shadow-lg">
            {/* Left Side - Car Image */}
            <div className="w-full sm:w-1/2 hidden sm:flex items-center justify-center rounded-l-lg">
