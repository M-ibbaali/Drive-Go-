...
function Settings({
  ...
  return (
    <>
      <div className="max-w-full md:max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden px-4">
        ...
        >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <label className="text-gray-700 font-medium">
              {tempTheme === "Dark" ? "Dark" : "Light"} Mode
            </label>
          </div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <button
              ...
              className="p-2 rounded-full border border-gray-300 shadow-md focus:outline-none hover:opacity-75"
              style={{
                backgroundColor: tempNotification ? "#4caf50" : "#f0f0f0",
                color: tempNotification ? "white" : "gray",
              }}
            >
              {tempNotification ? (
