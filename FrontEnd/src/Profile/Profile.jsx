...
function Profile({ setData }) {
  ...
  const handleSaveChangesToDB = async () => {
    try {
      const response = await fetch(
        "http://localhost/drive-go/BackEnd/Profile/profile.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex flex-col sm:flex-row items-center sm:space-x-6 mb-8">
              ...
              <button
                onClick={toggleModal}
                className="mt-4 sm:mt-0 sm:ml-auto px-4 py-2 flex items-center space-x-1 text-white bg-blue-600 rounded-lg hover:bg-blue-500 transition-all"
              >
